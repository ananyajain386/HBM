...
function Bookings_ao(){
    const [data,setData]=useState([])
    useEffect(()=>{
        inst.get('api/aobooked/').then(response=>{setData(response.data)
            ...
            <table className="min-w-full text-left font-light">
              <thead className="border-b font-medium dark:border-neutral-500 text-2xl">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-4">HOD Remark</th>
                  <th scope="col" className="px-6 py-4">HOD status</th>
              ...
              return (
                <tr className="border-b dark:border-neutral-500">
                  ...
                  <td className=" px-6 py-4">{item.hod_remark}</td>
                  <td className=" px-6 py-4">{item.hod_approval_status}</td>                  
