...
function Allbookings(){
    ...
    useEffect(()=>{
        inst.get('api/hodallbookings/').then(response=>{setData(response.data)
            ...
            <table className="min-w-full text-left font-light">
              <thead className="border-b font-medium dark:border-neutral-500 text-2xl">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-4">AO Status</th>
              ...
              return (
                <tr className="border-b dark:border-neutral-500">
                  ...
                  <td className=" px-6 py-4">{JSON.stringify(item.hod_approval_status)}</td>
